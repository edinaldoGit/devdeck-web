...
<template>
  <div class="view-content">
    ...
    <div class="toolbar">
      <button class="btn-action-white" @click="handleSave" :disabled="isSaving">
    ...
    <div class="profile-layout-grid">
      ...
      <section class="glass-section h-full">
        ...
        <div class="inputs-grid two-col-mobile">
          ...
          <div class="form-group"><label>Cargo / Título</label><input v-model="form.role" type="text" class="input-premium" placeholder="Ex: Fullstack Developer" /></div>
      ...
      <section class="glass-section h-full social-section">
        ...
        <div class="inputs-grid single-col social-grid-content">
          <div class="form-group"><label><i class="bi bi-github"></i> GitHub</label><input v-model="form.social.github" type="text" class="input-premium" /></div>
          <div class="form-group"><label><i class="bi bi-linkedin"></i> LinkedIn</label><input v-model="form.social.linkedin" type="text" class="input-premium" /></div>
          <div class="form-group"><label><i class="bi bi-globe"></i> Site / Portfólio</label><input v-model="form.social.website" type="text" class="input-premium" /></div>
        </div>
      </section>
...
.btn-action-white { background: #ffffff; color: var(--color-primary); border: none; padding: 0.7rem 1.5rem; border-radius: 50px; font-weight: 700; font-size: 0.95rem; display: flex; align-items: center; gap: 10px; cursor: pointer; box-shadow: 0 4px 10px rgba(0,0,0,0.1); transition: transform 0.2s ease; }
.btn-action-white:hover { transform: scale(1.05); }
.btn-action-white:active { transform: scale(0.95); }
.btn-action-white:disabled { opacity: 0.7; cursor: not-allowed; }
...
.social-section .social-grid-content {
  flex: 1; 
  display: flex; 
...
.input-premium:focus { background: white; border-color: var(--color-primary); outline: none; box-shadow: 0 0 0 3px rgba(255,255,255,0.2); }
...
.accordion-content { padding: 1.2rem; background: rgba(0,0,0,0.1); border-top: 1px solid rgba(255,255,255,0.05); }

/* --- Empty State --- */
.empty-section {
  display: flex; flex-direction: column; align-items: center; justify-content: center;
  padding: 2.5rem; border: 2px dashed rgba(255, 255, 255, 0.2);
...
.tag-input-transparent { border: none; background: transparent; flex: 1; min-width: 200px; outline: none; color: #1e293b; font-size: 0.95rem; }
